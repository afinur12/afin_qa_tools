...
def build_docx(testcase, output_path: str) -> str:
    ...
    fields = {
        ...
        "tester": testcase.tester_user.name if testcase.tester_user else None,
        "test_date": _format_test_date(testcase.test_date),
        "environment": testcase.subtask.phase.type.value,
        "test_priority": testcase.test_priority_ref.name.upper() if testcase.test_priority_ref else None,
